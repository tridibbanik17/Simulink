...
plot(ans.Cell_SOC, ans.Cell_Voltage)
title('SOC vs cell voltage');

plot(ans.tout, ans.Cell_Voltage)
title('Time vs cell voltage');

plot(ans.Cell_Current, ans.Cell_Voltage)
title('cell current vs cell voltage');
