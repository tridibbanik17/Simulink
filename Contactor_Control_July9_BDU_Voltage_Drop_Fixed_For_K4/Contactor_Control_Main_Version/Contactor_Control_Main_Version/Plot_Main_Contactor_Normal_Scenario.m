...
exportgraphics(gcf, 'Main_Contactor_Normal_1.png', 'Resolution', 600);
...
% === Export high-resolution figure ===
exportgraphics(gcf, 'Main_Contactor_Normal_2.png', 'Resolution', 600);
...
% === Export figure ===
exportgraphics(gcf, 'Main_Contactor_Normal_3.png', 'Resolution', 600);
...
legend([h_signal], ...
    ...
    'Location', 'southeast', ...
    'FontSize', 22);
exportgraphics(gcf, 'Main_Contactor_Normal_4.png', 'Resolution', 600);
...
axis off; box off;
exportgraphics(gcf, 'Main_Contactor_Normal_5.png', 'Resolution', 600);