...
exportgraphics(gcf, 'Main_Contactor_Shorted_High_1.png', 'Resolution', 600);
...
text(0.005, Max_Precharge_Current, ...
...
% === Export high-resolution figure ===
exportgraphics(gcf, 'Main_Contactor_Shorted_High_2.png', 'Resolution', 600);
...
% === Export figure ===
exportgraphics(gcf, 'Main_Contactor_Shorted_High_3.png', 'Resolution', 600);
...
exportgraphics(gcf, 'Main_Contactor_Shorted_High_4.png', 'Resolution', 600);
...
axis off
box off
exportgraphics(gcf, 'Main_Contactor_Shorted_High_5.png', 'Resolution', 600);
