...
% % Overlay coil diagnostic states
...
scatter(ans.Time(ans.K4_Coil_State == 0), repmat(1.3, sum(ans.K4_Coil_State == 0), 1), 20, 'bo', 'filled', 'DisplayName', 'K1: OPEN');
scatter(ans.Time(ans.K4_Coil_State == 1), repmat(1.3, sum(ans.K4_Coil_State == 1), 1), 20, 'g^', 'filled', 'DisplayName', 'K1: NORMAL');
scatter(ans.Time(ans.K4_Coil_State == 2), repmat(1.3, sum(ans.K4_Coil_State == 2), 1), 20, 'rs', 'filled', 'DisplayName', 'K1: SHORTED\_HIGH');
scatter(ans.Time(ans.K4_Coil_State == 3), repmat(1.3, sum(ans.K4_Coil_State == 3), 1), 20, 'mo', 'filled', 'DisplayName', 'K1: SHORTED\_LOW');
