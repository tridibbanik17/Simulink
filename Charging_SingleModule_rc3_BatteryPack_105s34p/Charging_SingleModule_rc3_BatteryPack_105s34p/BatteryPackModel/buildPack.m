...
for i = 1:total_series_cells
    cell = Cell( ...
        ...
        Energy = simscape.Value(17.787, "W*hr") ... % Nominal Voltage * capacitance = energy
    );
...
modules_type1 = modules(1:1);             % Type 1: 24 modules
...
batterypack = Pack( ...
    ModuleAssembly = [moduleassembly_type1], ...
    StackingAxis = "Y", ...
