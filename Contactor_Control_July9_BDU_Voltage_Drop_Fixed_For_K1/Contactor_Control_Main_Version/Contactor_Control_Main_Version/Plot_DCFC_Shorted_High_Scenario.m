...
exportgraphics(gcf, 'DCFC_Contactor_Shorted_High_1.png', 'Resolution', 600);
...
% === Export high-resolution figure ===
exportgraphics(gcf, 'DCFC_Contactor_Shorted_High_2.png', 'Resolution', 600);
...
% === Export figure ===
exportgraphics(gcf, 'DCFC_Contactor_Shorted_High_3.png', 'Resolution', 600);
...
legend([h_signal], ...
    ...
    'Location', 'southeast', ...
    'FontSize', 22);
exportgraphics(gcf, 'DCFC_Contactor_Shorted_High_4.png', 'Resolution', 600);
...
axis off
box off
exportgraphics(gcf, 'DCFC_Contactor_Shorted_High_5.png', 'Resolution', 600);